...
@WebServlet("/mem/updateMemInfo")
public class UpdateMemInfoServlet extends HttpServlet {
	private static final long serialVersionUID = -1554691707300228387L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try(BufferedReader br = req.getReader();){
			...
			mem = service.updatePersonalInfo(mem);
