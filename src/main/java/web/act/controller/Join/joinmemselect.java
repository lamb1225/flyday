...
@WebServlet("/Act/joinmem")
public class joinmemselect extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        final Integer id = json2Pojo(req, Act_Join.class).getMemno();
        writePojo2Json(resp,service.memJoin(id));
    }
}
