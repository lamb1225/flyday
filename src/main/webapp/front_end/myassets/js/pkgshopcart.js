    ...
    fetch('/flyday/pkg/PkgShopFindAll', {
        ...
        .then(function (data) {
            ...
            <div class="row main align-items-center">
                ...
                <div class="col">
                    <label>數量</label>
                    <input class="form-control" style="width:80px;margin-top: 30%;" type="number" id="count" value="${data[i].pkgQty}"
                    onblur="calculateTotal(this, ${data[i].pkgPlanNo})" min="0" max="1000000" maxlength="7">
                </div>
